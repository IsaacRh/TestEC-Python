...
def set_text(text):
    ...
    for character in text:
        if (character in vowels_lowercase) or (character in vowels_uppercase) or (character in accented_vowels_lowercase) or (character in accented_vowels_uppercase):
            ...
            elif character in vowels_uppercase : vowels_array = vowels_uppercase
            elif character in accented_vowels_lowercase : vowels_array = accented_vowels_lowercase
            elif character in accented_vowels_uppercase : vowels_array = accented_vowels_uppercase
